...
const Hero: React.FC<HeroProps> = ({ onNavigate }) => {
  return (
    <header className="pt-40 pb-32 px-6 relative overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-gradient-to-b from-orange-500/10 to-purple-500/10 blur-[120px] rounded-full -z-10 animate-float-lg opacity-40"></div>
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        <p className="text-gray-400 text-xl md:text-2xl max-w-3xl mx-auto mb-12 font-medium leading-relaxed">
          ...
          Augmentez votre chiffre d'affaires de <span className="text-orange-500 font-bold">+30%</span> sans surcharge mentale.
        </p>
        
        <div className="flex flex-col sm:flex-row justify-center gap-5 items-center">
          <a href="#contact-section" className="w-full sm:w-auto bg-orange-500 text-white px-10 py-5 rounded-2xl font-bold text-lg md:text-xl hover:bg-orange-600 transition-all hover:shadow-[0_10px_40px_-10px_rgba(249,115,22,0.5)] hover:-translate-y-1 active:scale-95 flex items-center justify-center relative overflow-hidden group">
        ...
        <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-8 opacity-60 hover:opacity-100 transition-opacity duration-500">
          <div className="flex flex-col items-center gap-2 group cursor-default">
            <div className="w-12 h-12 bg-orange-900/20 border border-orange-500/20 rounded-xl flex items-center justify-center mb-2 group-hover:scale-110 transition-transform text-orange-500">
