    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <button className="hidden sm:block text-sm font-bold text-gray-400 hover:text-orange-400 transition-colors">Se connecter</button>
          <a 
            href="#contact-section"
            className="bg-orange-500 hover:bg-orange-600 px-6 py-2.5 rounded-full font-bold text-sm text-white transition-all hover:shadow-[0_0_25px_rgba(249,115,22,0.6)] hover:scale-105 active:scale-95"
          >
            Demander une Démo
          </a>
        </div>
